...
All the environments are registered in the `jason_lab` extension. They start
...
import jason_lab.tasks  # noqa: F401
import jason_lab.tasks.manager_based.locomotion.velocity.config.humanoid.jason_q1

def main():
    """Print all environments registered in `jason_lab` extension."""
